...
# Generated by qmake (2.01a) (Qt 4.8.0) on: Sun Apr 1 13:32:04 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-MacOSX/QtExample1.0.0/ && $(COPY_FILE) --parents mvp/Presenter.h services/BondPricerService.h MyApplication.h View.h MyCanvasView.h utils.h BondComputationResultForm.h MyApplicationPresenter.h mvp/Event.h UnCopyable.h MyCanvasPresenter.h BondForm.h ChangeTextEvent.h CanvasWidget.h BondView.h build/Debug/GNU-MacOSX/QtExample1.0.0/ && $(COPY_FILE) --parents BondForm.cpp MyCanvasPresenter.cpp services/BondPricerService.cpp MyApplicationPresenter.cpp main.cpp MyCanvasView.cpp mvp/View.cpp CanvasWidget.cpp BondComputationResultForm.cpp BondView.cpp MyApplication.cpp build/Debug/GNU-MacOSX/QtExample1.0.0/ && $(COPY_FILE) --parents BondForm.ui BondComputationResultForm.ui build/Debug/GNU-MacOSX/QtExample1.0.0/ && (cd `dirname build/Debug/GNU-MacOSX/QtExample1.0.0` && $(TAR) QtExample1.0.0.tar QtExample1.0.0 && $(COMPRESS) QtExample1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-MacOSX/QtExample1.0.0`/QtExample1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-MacOSX/QtExample1.0.0
