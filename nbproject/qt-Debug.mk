...
# Generated by qmake (2.01a) (Qt 4.8.0) on: Sun Mar 18 18:17:48 2012
...
INCPATH       = -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/mkspecs/macx-g++ -Inbproject -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/lib/QtCore.framework/Versions/4/Headers -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/include/QtCore -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/lib/QtGui.framework/Versions/4/Headers -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/include/QtGui -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/include -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/include -Inbproject -I../../../dev/boost_1_47_0 -I../../../dev/gtest-1.6.0/include -I. -I. -F/book/dev/QtSDK/Desktop/Qt/4.8.0/gcc/lib
LINK          = g++
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-MacOSX/QtExample1.0.0/ && $(COPY_FILE) --parents mvp/Presenter.h MyApplication.h View.h MyCanvasView.h utils.h MyApplicationView.h MyApplicationPresenter.h mvp/Event.h MyCanvasPresenter.h ChangeTextEvent.h CanvasWidget.h mvp/EventHandler.h mvp/EventBus.h build/Debug/GNU-MacOSX/QtExample1.0.0/ && $(COPY_FILE) --parents MyCanvasPresenter.cpp ChangeTextEvent.cpp tests/SimpleTest.cpp MyApplicationPresenter.cpp main.cpp MyApplicationView.cpp mvp/View.cpp MyCanvasView.cpp Event.cpp mvp/EventHandler.cpp CanvasWidget.cpp mvp/EventBus.cpp MyApplication.cpp build/Debug/GNU-MacOSX/QtExample1.0.0/ && (cd `dirname build/Debug/GNU-MacOSX/QtExample1.0.0` && $(TAR) QtExample1.0.0.tar QtExample1.0.0 && $(COMPRESS) QtExample1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-MacOSX/QtExample1.0.0`/QtExample1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-MacOSX/QtExample1.0.0
