...
# Generated by qmake (2.01a) (Qt 4.8.0) on: Tue Mar 27 23:38:34 2012
...
INCPATH       = -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/mkspecs/macx-g++ -Inbproject -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/lib/QtCore.framework/Versions/4/Headers -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/include/QtCore -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/lib/QtGui.framework/Versions/4/Headers -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/include/QtGui -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/include -I../../../dev/QtSDK/Desktop/Qt/4.8.0/gcc/include -Inbproject -I../../../dev/boost_1_47_0 -I../../../dev/QuantLib-1.2 -I../../../dev/gtest-1.6.0/include -I../../../dev/threadpool-0.2.5 -I../../../dev/poco-1.4.3p1/Foundation/include -I. -I. -F/book/dev/QtSDK/Desktop/Qt/4.8.0/gcc/lib
LINK          = g++
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-MacOSX/QtExample1.0.0/ && $(COPY_FILE) --parents mvp/Presenter.h services/BondPricerService.h MyApplication.h View.h MyCanvasView.h utils.h MyApplicationView.h MyApplicationPresenter.h mvp/Event.h UnCopyable.h MyCanvasPresenter.h ChangeTextEvent.h CanvasWidget.h build/Debug/GNU-MacOSX/QtExample1.0.0/ && $(COPY_FILE) --parents MyCanvasPresenter.cpp services/BondPricerService.cpp MyApplicationPresenter.cpp main.cpp MyApplicationView.cpp MyCanvasView.cpp mvp/View.cpp CanvasWidget.cpp MyApplication.cpp build/Debug/GNU-MacOSX/QtExample1.0.0/ && (cd `dirname build/Debug/GNU-MacOSX/QtExample1.0.0` && $(TAR) QtExample1.0.0.tar QtExample1.0.0 && $(COMPRESS) QtExample1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-MacOSX/QtExample1.0.0`/QtExample1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-MacOSX/QtExample1.0.0
