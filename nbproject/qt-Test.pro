...
CONFIG += debug 
QT = core gui
SOURCES += MyCanvasPresenter.cpp ChangeTextEvent.cpp tests/SimpleTest.cpp MyApplicationPresenter.cpp MyApplicationView.cpp mvp/View.cpp MyCanvasView.cpp Event.cpp mvp/EventHandler.cpp CanvasWidget.cpp mvp/EventBus.cpp MyApplication.cpp
