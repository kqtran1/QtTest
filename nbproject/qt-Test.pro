...
CONFIG += debug 
QT = core gui
SOURCES += MyCanvasPresenter.cpp services/BondPricerService.cpp MyApplicationPresenter.cpp MyApplicationView.cpp MyCanvasView.cpp mvp/View.cpp CanvasWidget.cpp MyApplication.cpp
