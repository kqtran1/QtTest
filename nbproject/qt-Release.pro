...
CONFIG += release 
QT = core gui
SOURCES += BondForm.cpp MyCanvasPresenter.cpp services/BondPricerService.cpp MyApplicationPresenter.cpp main.cpp MyCanvasView.cpp BondTableModel.cpp BondCalculationTask.cpp CanvasWidget.cpp BondComputationResultForm.cpp BondView.cpp MyApplication.cpp
